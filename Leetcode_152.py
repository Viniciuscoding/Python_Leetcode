...
# This is becacuse if you have [-1,-2,-100] then subarray is [-1,2,-200] but the inverse array [-100,-2,-1] will yield
...
# Concatenate both arrays together and return the largest contigous array.
