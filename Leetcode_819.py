...
class Solution(object):
    def mostCommonWord(self, paragraph, banned):
        ...
        # MY SOLUTION
        lcase_paragraph = paragraph.lower()
        words_only = re.findall(r'\w+', lcase_paragraph)
        return Counter(word for word in words_only if word not in banned).most_common()[0][0]
