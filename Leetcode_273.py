...
#     2.3 Check for numbers < 1000 Notice that any number >= 100 and < 1000 you add the name hundred and check for the 
#         remainder of a module of a 100 on step 2.2 or 2.1 again.
...
#         value by concatenating with the previous steps.
# 3. This pattern will concur from the highest case until it gets to its smallest case.
